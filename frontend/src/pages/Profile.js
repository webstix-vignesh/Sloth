    ...
    <Main >
        ...
        title={
          <Row justify="space-between" align="middle" gutter={[24, 0]}>
            <Col span={24} md={12} className="col-info">
              ...
              <Avatar size={74} shape="square" src={user?.avatar_url} />
               {/* <img src={project1} alt="UserImage"  /> */}

                <div className="avatar-info">
               
                <h4 className="font-semibold m-0">{user?.full_name}</h4>
      ...
      <Col span={24} md={8} className="mb-24">
          <Card
            ...
            extra={<Link to="/profile1"><Button type="link">{pencil}</Button></Link>}
