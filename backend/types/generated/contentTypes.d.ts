...
export interface ApiLeaveLeave extends Schema.CollectionType {
  ...
  attributes: {
    ...
    emp_id: Attribute.String & Attribute.Required;
    leave_type: Attribute.String & Attribute.Required;
    reports_to: Attribute.String & Attribute.Required;
    reason: Attribute.Text & Attribute.Required;
    leave_user_id: Attribute.BigInteger;
    start_date: Attribute.String & Attribute.Required;
    end_date: Attribute.String & Attribute.Required;
    leave_status: Attribute.String & Attribute.Required;
    leave_comments: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiReportingManagerReportingManager
  extends Schema.CollectionType {
  collectionName: 'reporting_managers';
  info: {
    singularName: 'reporting-manager';
    pluralName: 'reporting-managers';
    displayName: 'reportingManager';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::reporting-manager.reporting-manager',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    avatar_url: Attribute.String & Attribute.Required;
    full_name: Attribute.String & Attribute.Required;
    ...
    emp_id: Attribute.String & Attribute.Required & Attribute.Unique;
    user_image: Attribute.Media & Attribute.Required;
    No_of_SL: Attribute.BigInteger & Attribute.Required;
    No_of_EL: Attribute.BigInteger & Attribute.Required;
    No_of_CL: Attribute.BigInteger & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::reporting-manager.reporting-manager': ApiReportingManagerReportingManager;
